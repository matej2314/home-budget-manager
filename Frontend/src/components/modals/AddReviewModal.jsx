        ...
        >
            <div className='w-full h-full flex justify-center items-center'>
                <form onSubmit={handleSaveReview}>
                    <label htmlFor="choose_rating">Choose rating:</label>
                    <StarRating edit={true} action={(newRating) => setRating(newRating)} />
                    <label htmlFor="userOpinion">Type your opinion:</label>
                    <textarea name="" id="" ref={userOpinionRef} />
