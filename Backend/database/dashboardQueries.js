module.exports = {
    ...
    messagesData: `SELECT m.id AS id, m.content AS message, m.is_read AS readed, m.datetime AS date, u1.name AS sender, u2.name AS recipient FROM messages m JOIN 
