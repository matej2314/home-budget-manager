module.exports = {
    ...
    getQuery: 'SELECT t.transactionId AS transaction_id, t.value, t.addedAt, t.houseId, t.catId, t.userId AS userId, c.name AS category_name FROM transactions t JOIN actionCategories c ON t.catId = c.id WHERE t.houseId = ?; ',
