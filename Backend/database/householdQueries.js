module.exports = {
    ...
    dataQuery: `SELECT h.houseId, h.houseName, h.initBudget, h.balanceDate, hu.userId, hu.userName,
     hu.role FROM households h JOIN householdUsers hu ON h.houseId = hu.houseId WHERE h.houseId = ?;`,
