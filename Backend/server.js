...
const allowedOrigins = ['https://budgetapp.msliwowski.net', 'https://budgetapi.msliwowski.net', 'http://localhost:5173', 'http://185.170.196.107:5052', 'http://budgetapp.msliwowski.net'];
