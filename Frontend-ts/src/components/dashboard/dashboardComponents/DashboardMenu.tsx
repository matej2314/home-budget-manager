...
import OpenMenuButton from '@components/dashboard/dashboard-internal-components/OpenMenuButton';
                    ...
                    <ul className='w-full flex flex-col items-center justify-start gap-6'>
                        {linksElements.map((link, index) => (
                            ...
                            >
                                ...
                                {link.dot && newMessages &&  newMessages.length > 0 ? <NotificationDot color={'bg-green-700'} data={newMessages.length} head={false} /> : null}
                            </li>
                        ))}
