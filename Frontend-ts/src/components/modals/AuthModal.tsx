...
import Authorization from '@components/homePageComponents/Authorization';
...
export default function AuthModal({ isOpen, onRequestClose }: AuthModalProps) {
    ...
    const handleModeChange = (selectedMode: ModeStateType) => {
        setMode(selectedMode);
    };

    const handleLoginBtn = (selectedMode: ModeStateType) => {
        if (isAuthenticated) {
